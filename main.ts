...
console.log(`  SL       : $${process.env.SL_FIXED_USD ?? '10.00'} price move (stop-market, taker ~0.04% only when it fires)`);
console.log(`  BREAKEVEN: ~53.8% WR (symmetric bracket + taker fee on SL — leverage-invariant)`);
